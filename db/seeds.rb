...
Country.create([
{iso: "AF", name: "AFGHANISTAN", printable_name: "Afghanistan", iso3: "AFG", numcode: 4},
{iso: "AL", name: "ALBANIA", printable_name: "Albania", iso3: "ALB", numcode: 8},
{iso: "DZ", name: "ALGERIA", printable_name: "Algeria", iso3: "DZA", numcode: 12},
{iso: "AS", name: "AMERICAN SAMOA", printable_name: "American Samoa", iso3: "ASM", numcode: 16},
{iso: "AD", name: "ANDORRA", printable_name: "Andorra", iso3: "AND", numcode: 20},
{iso: "AO", name: "ANGOLA", printable_name: "Angola", iso3: "AGO", numcode: 24},
{iso: "AI", name: "ANGUILLA", printable_name: "Anguilla", iso3: "AIA", numcode: 660},
{iso: "AG", name: "ANTIGUA AND BARBUDA", printable_name: "Antigua and Barbuda", iso3: "ATG", numcode: 28},
{iso: "AR", name: "ARGENTINA", printable_name: "Argentina", iso3: "ARG", numcode: 32},
{iso: "AM", name: "ARMENIA", printable_name: "Armenia", iso3: "ARM", numcode: 51},
{iso: "AW", name: "ARUBA", printable_name: "Aruba", iso3: "ABW", numcode: 533},
{iso: "AU", name: "AUSTRALIA", printable_name: "Australia", iso3: "AUS", numcode: 36},
{iso: "AT", name: "AUSTRIA", printable_name: "Austria", iso3: "AUT", numcode: 40},
{iso: "AZ", name: "AZERBAIJAN", printable_name: "Azerbaijan", iso3: "AZE", numcode: 31},
{iso: "BS", name: "BAHAMAS", printable_name: "Bahamas", iso3: "BHS", numcode: 44},
{iso: "BH", name: "BAHRAIN", printable_name: "Bahrain", iso3: "BHR", numcode: 48},
{iso: "BD", name: "BANGLADESH", printable_name: "Bangladesh", iso3: "BGD", numcode: 50},
{iso: "BB", name: "BARBADOS", printable_name: "Barbados", iso3: "BRB", numcode: 52},
{iso: "BY", name: "BELARUS", printable_name: "Belarus", iso3: "BLR", numcode: 112},
{iso: "BE", name: "BELGIUM", printable_name: "Belgium", iso3: "BEL", numcode: 56},
{iso: "BZ", name: "BELIZE", printable_name: "Belize", iso3: "BLZ", numcode: 84},
{iso: "BJ", name: "BENIN", printable_name: "Benin", iso3: "BEN", numcode: 204},
{iso: "BM", name: "BERMUDA", printable_name: "Bermuda", iso3: "BMU", numcode: 60},
{iso: "BT", name: "BHUTAN", printable_name: "Bhutan", iso3: "BTN", numcode: 64},
{iso: "BO", name: "BOLIVIA", printable_name: "Bolivia", iso3: "BOL", numcode: 68},
{iso: "BA", name: "BOSNIA AND HERZEGOVINA", printable_name: "Bosnia and Herzegovina", iso3: "BIH", numcode: 70},
{iso: "BW", name: "BOTSWANA", printable_name: "Botswana", iso3: "BWA", numcode: 72},
{iso: "BR", name: "BRAZIL", printable_name: "Brazil", iso3: "BRA", numcode: 76},
{iso: "BN", name: "BRUNEI DARUSSALAM", printable_name: "Brunei Darussalam", iso3: "BRN", numcode: 96},
...
{iso: "SB", name: "SOLOMON ISLANDS", printable_name: "Solomon Islands", iso3: "SLB", numcode: 90},
...
{iso: "VG", name: "VIRGIN ISLANDS, BRITISH", printable_name: "Virgin Islands, British", iso3: "VGB", numcode: 92},
...
# User.create([
# 	{email: 'hope3@taskassure.com', ta_api_token: '822dfd0a-61e4-4154-9145-1b1ee9f91093'},
# 	{email: 'hopezz@taskassure.com', ta_api_token: '17c16d2e-7688-44f4-8952-1435734a9e0d'}
# 	])

Category.reset_column_information
Category.create([
         {name: 'Cooking', url: 'service_categories/chef.png'},
         {name: 'Exercise', url: 'service_categories/fitnesstrainer.png'},
         {name: 'Health Care', url: 'service_categories/medical.png'},
         {name: 'Home Repairs', url: 'service_categories/handiman.png'},
         {name: 'House Chores', url: 'service_categories/housework.png'},
         {name: 'House Cleaning', url: 'service_categories/housecleaning.png'},
         {name: 'Laundry', url: 'service_categories/laundry.png'},
         {name: 'Lawn Care', url: 'service_categories/gardening.png'},
         {name: 'Personal Assistance', url: 'service_categories/personalassist.png'},
         {name: 'Pet Care', url: 'service_categories/pet.png'},
         {name: 'Shopping', url: 'service_categories/shopping.png'},
         {name: 'Transportation', url: 'service_categories/transportation.png'},
         {name: 'Other', url: 'service_categories/misc.png'}
         ])
